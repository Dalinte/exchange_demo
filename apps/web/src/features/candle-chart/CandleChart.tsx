...
export function CandleChart({ candles, pair, timeframe, onTimeframe }: CandleChartProps) {
  ...
  if (!stats || size.w < 60) {
    return <div ref={wrapRef} style={{ flex: 1, position: 'relative', minHeight: 200 }} />;
  }
  ...
  for (let i = 0; i <= ticks; i++) {
    tickVals.push(lo + (hi - lo) * (i / ticks));
  }
